...
# the Apostle's stall: tucked beside the grand stair at the palace door,
# table run parallel to the west flank bay so nothing kisses the arch —
# wares, candles to read prices by (glory only, like its keeper)
PR.append({"kit": "banquet_table_6m", "at": [-7.6, 0, -8.6], "rot": 90, "tag": "glory"})
PR.append({"kit": "book_stack", "at": [-7.6, 0.9, -9.6], "rot": 75, "tag": "glory", "collide": False})
PR.append({"kit": "scroll_pile", "at": [-7.6, 0.9, -7.6], "rot": -20, "tag": "glory", "collide": False})
PR.append({"kit": "candle_cluster", "at": [-6.2, 0, -6.9], "rot": 10, "tag": "glory"})
PR.append({"kit": "candle_cluster", "at": [-8.3, 0, -5.5], "rot": -35, "tag": "glory"})
...
def main():
    data = {
        ...
        "npcs": [
            {"id": "apostle_light", "at": [-6.3, 0, -10.3], "rot": 40, "tag": "glory"},
        ],
